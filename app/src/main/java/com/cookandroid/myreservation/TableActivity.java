...
public class TableActivity extends Activity {
    ...
    Integer[] numBtnIDs = { R.id.BtnNum0,R.id.BtnNum1,R.id.BtnNum2,R.id.BtnNum3,R.id.BtnNum4,
            ...
            R.id.BtnNum15,R.id.BtnNum16,R.id.BtnNum17,R.id.BtnNum18,R.id.BtnNum19,
            R.id.BtnNum20,R.id.BtnNum21,R.id.BtnNum22,
            R.id.BtnNum23,R.id.BtnNum24, R.id.BtnNum25,R.id.BtnNum26,
            R.id.BtnNum27, R.id.BtnNum28 };
    int i;
    //dialog 변수
